...
//	WT.sp="@@SPLITVALUE@@";
	WT.dl="0";
	WT.ssl=(window.location.protocol.indexOf('Reference.html')==0)?"1":"0";
...
WebTrends.prototype.dcsTag=function(){
	...
	var i18n=this.i18n;
	var P="http"+(window.location.protocol.indexOf('Reference.html')==0?'s':'')+"://"+this.domain+(this.dcsid==""?'':'/'+this.dcsid)+"/dcs.gif?";
	if (i18n){
		WT.dep="";
	}
	for (var N in DCS){
